 ...
 * @since 3.0.0
 */
export const get: Req<string> = pipe(request, RTE.local(setMethod('GET')));
 ...
 * @since 3.0.0
 */
export const post: Req<string> = pipe(request, RTE.local(setMethod('POST')));
 ...
 * @since 3.0.0
 */
export const put: Req<string> = pipe(request, RTE.local(setMethod('PUT')));
 ...
 * @since 3.0.0
 */
export const patch: Req<string> = pipe(request, RTE.local(setMethod('PATCH')));
 ...
 * @since 3.0.0
 */
export const del: Req<string> = pipe(request, RTE.local(setMethod('DELETE')));
