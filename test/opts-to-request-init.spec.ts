...
test('should return a RequestInit object with data from ApiOptions - use defaults', () => {
  expect(optsToRequestInit(CONFIG1, OPTS3)).toEqual({
    headers: {
      Accept: 'application/json',
      'Content-type': 'application/json',
      'Custom-Header': 'custom'
  ...
  expect(optsToRequestInit(CONFIG2, OPTS3)).toEqual({
    headers: {
      Accept: 'application/json',
      'Content-type': 'application/json',
      'Contactlab-ClientId': 'App',
  ...
  expect(optsToRequestInit(CONFIG3, OPTS3)).toEqual({
    headers: {
      Accept: 'application/json',
      'Content-type': 'application/json',
      'Contactlab-ClientId': 'App',
...
test('should return a RequestInit object with data from ApiOptions - ovveride defaults', () => {
  expect(optsToRequestInit(CONFIG1, OPTS4)).toEqual({
    headers: {
      Accept: 'text/html',
      'Content-type': 'text/html'
    },
